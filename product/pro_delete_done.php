...
<body>
  <?php
    try {
        $pro_code = $_POST['code']; //前の画面からpostメソッドから受け取ったデータを変数に代入
        $pro_gazou_name = $_POST['gazou_name']; //前の画面からpostメソッドから受け取ったデータを変数に代入
        ...
        $sql = 'DELETE FROM mst_product WHERE code=?'; //SQL文を変数に代入
